...
public abstract class PlayerListHudMixin {
	...
	private void redirectRenderLatencyIconCall(
			PlayerListHud instance, DrawContext drawContext, int width, int x, int y, @NotNull PlayerListEntry entry) {
		CustomPlayerListHud.renderPingDisplay(client, instance, drawContext, width, x, y, entry);
	}
}
